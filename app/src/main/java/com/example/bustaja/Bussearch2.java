...
//
//public class Bussearch2 extends AppCompatActivity {
//    Context context;
//    public static final String TAG = Bussearch2.class.getSimpleName();
//    public EditText edit;
//    public Button send;
//    TextView status1;
//    // http://www.data.go.kr 에서 로그인 후 API 조회하여 신청 승인받은 key 값
//    String key = "HPhv7q1fispfruW2r4aROp%2FvBjNa6M0jg%2F1FVE4BliwYYTY4oWQ54%2Fs10n8Ny2eFJcTKZ21NEbFaC%2BSs%2BGWNSQ%3D%3D"; // 실제 키값이 아님 (변경처리함)
//
//    @Override
